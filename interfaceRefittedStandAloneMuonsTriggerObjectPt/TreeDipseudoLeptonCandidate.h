...
struct TreeDipseudoLeptonCandidate
{
  TreeDipseudoLeptonCandidate() :
    ...
    leptonD0L_PVrefitCorr(-9999), leptonD0H_PVrefitCorr(-9999), leptonD0SignificanceL_PVrefit_includingPVErrorCorr(-9999.), leptonD0SignificanceH_PVrefit_includingPVErrorCorr(-9999.),
    ...
    cosine(1.), deltaR(-999.), deltaRSMS(-999), distanceSMS(-999), cosineCorr(1.), deltaRCorr(-999.), deltaRSMSCorr(-999), distanceSMSCorr(-999),
    cosThetaStar(-999.), mass(-999.), corrDileptonMass(-999.),
  ...
  Float_t deltaRSMS; // at the second muon station for trigger inefficiencies. Leave unbiased as above.
  Float_t distanceSMS; // distance between the positions of the two leptons at the second muon station.
  Float_t cosineCorr; // to reject cosmics, use the refitted leptons.
  Float_t deltaRCorr; // for trigger inefficiencies, use the refitted leptons.
  Float_t deltaRSMSCorr; // at the second muon station for trigger inefficiencies, use the refitted leptons.
  Float_t distanceSMSCorr; // distance between the positions of the two refitted leptons at the second muon station.
  ...
  // Vector containing the indeces of the matched track-based candidates and the corresponding minimum deltaR
  std::vector<std::pair<Int_t, Float_t> > tkMatches;
